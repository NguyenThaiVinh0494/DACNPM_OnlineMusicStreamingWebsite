      ...
      <div className="w-[450px] bg-white dark:bg-[#222222] rounded-xl p-8 shadow-2xl relative border border-gray-200 dark:border-white/10 transition-colors duration-300">
        ...
        <div className="flex justify-between items-center mt-4 mb-8 text-sm">
          ...
          <span className="text-gray-500 dark:text-gray-400">
            {t('no_account')} <button onClick={onSwitchToRegister} className="text-green-500 dark:text-cyan-400 font-bold hover:text-green-600 dark:hover:text-cyan-300 transition-colors">{t('register')}</button>
          </span>
        </div>

        <button className="w-full bg-nct-primary hover:bg-[#2591c4] dark:bg-cyan-400 dark:hover:bg-cyan-500 text-white dark:text-black font-bold py-3.5 rounded-full transition-colors text-lg mb-8 shadow-[0_0_15px_rgba(45,170,237,0.3)] dark:shadow-[0_0_15px_rgba(34,211,238,0.2)] cursor-pointer">
          {t('login')}
        </button>
