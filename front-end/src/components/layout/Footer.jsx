      ...
      <div className="flex justify-between items-start mb-12">
        ...
        <div className="space-y-4 max-w-2xl">
          ...
          <ul className="text-sm text-nct-text-dim space-y-1.5 leading-relaxed">
            ...
            <li>
              • Giấy Chứng nhận Đăng ký Kinh doanh số 0305535715 do Sở kế hoạch
              và Đầu tư thành phố Hồ Chí Minh cấp ngày 01/03/2008.
            </li>
            <li>
              • Nhân sự chịu trách nhiệm quản lý nội dung thông tin: Ông Phan
              Hoài Nam
            </li>
            <li>
              • Địa chỉ: Tầng 19, Tòa nhà 678, 67 Hoàng Văn Thái, Phường Tân
