...
import { FiPlay, FiPause, FiHeart, FiMoreHorizontal, FiTrash2, FiClock, FiPlus, FiList, FiX, FiMusic, FiSearch, FiCheck } from "react-icons/fi";
...
export default function MyPlaylistDetail() {
  ...
  return (
    <div className="pb-20">
      ...
      <div className="flex gap-8 mb-10 items-end">
        <div className="w-[230px] h-[230px] shrink-0 rounded-xl overflow-hidden bg-gray-100 dark:bg-[#2a2a2a] relative group flex items-center justify-center shadow-lg border border-gray-200 dark:border-white/5">
          {playlist.songs.length > 0 ? (
            ...
            <FiMusic className="w-20 h-20 text-white/20" />
          )}
        </div>
      ...
      <div>
        {playlist.songs.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-20 mt-10 border-t border-white/5">
          ...
          <div className="bg-transparent">
              ...
              <div className="flex items-center text-gray-900 dark:text-white text-sm font-medium px-4 py-0 border-b border-gray-200 dark:border-white/5 bg-gray-100 dark:bg-[#282828] h-[56px] rounded-t-md">
                ...
                <div className="flex-1 flex items-center gap-5 pl-2">
                  ...
                  <div className="flex items-center gap-5 border-l border-gray-300 dark:border-white/10 pl-5">
                    ...
                    <button className="flex items-center gap-2 text-white hover:text-nct-primary transition-colors" title="Thêm vào yêu thích">
            ...
            <div className="mt-8 flex justify-center">
              <button 
                onClick={() => setIsAddModalOpen(true)}
                className="px-6 py-2 rounded-full border border-white/20 hover:border-nct-primary text-[#b3b3b3] hover:text-white transition-colors text-sm font-bold flex items-center gap-2"
              >
                <FiSearch className="w-4 h-4" /> Tìm thêm bài hát
              </button>
            </div>
          </div>
        )}
      ...
      {/* Modern Split-View Add Songs Modal */}
      {isAddModalOpen && (
          ...
          <div className="relative bg-white dark:bg-[#2a2a2a] border border-gray-200 dark:border-white/10 w-full max-w-md rounded-2xl shadow-2xl overflow-hidden">
            ...
            <div className="px-6 py-4 bg-gray-50 dark:bg-[#1e1e1e] flex justify-end gap-3 border-t border-gray-200 dark:border-white/5">
              ...
              <button 
                ...
                className="px-8 py-2 rounded-full bg-nct-primary hover:bg-[#2591c4] text-white font-bold transition-colors shadow-lg"
              >
                Lưu
              </button>
            </div>
