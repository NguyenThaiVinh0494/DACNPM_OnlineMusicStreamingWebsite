...
import { FiPlay, FiPause, FiHeart, FiMoreHorizontal, FiClock, FiPlus, FiList, FiCheck, FiX, FiSearch, FiMusic } from "react-icons/fi";
    ...
    <div className="pb-20">
      <div className="flex flex-col gap-8">
        ...
        <div className="flex items-start gap-8">
          <div className="w-[240px] h-[240px] shadow-2xl rounded-xl overflow-hidden group relative bg-gray-100 dark:bg-[#2a2a2a] flex items-center justify-center">
            {favorites.length > 0 ? (
              <>
                <img 
            ...
            <div className="flex items-center text-gray-900 dark:text-white text-sm font-medium px-4 py-0 border-b border-gray-200 dark:border-white/5 bg-gray-100 dark:bg-[#282828] h-[56px] rounded-t-md">
              ...
              <div className="flex-1 flex items-center gap-5 pl-2">
                ...
                <div className="flex items-center gap-5 border-l border-gray-300 dark:border-white/10 pl-5">
                  <button 
                    className="flex items-center gap-2 text-gray-900 dark:text-white hover:text-nct-primary transition-colors"
                    onClick={() => {
                  ...
                  <button className="flex items-center gap-2 text-gray-900 dark:text-white hover:text-nct-primary transition-colors">
                ...
                <div className="p-4 border-b border-gray-200 dark:border-white/5">
                  <div className="relative">
                    ...
                    <input 
                      ...
                      className="w-full bg-gray-100 dark:bg-[#2a2a2a] text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-[#b3b3b3] rounded-lg py-2.5 pl-10 pr-4 outline-none focus:ring-1 focus:ring-nct-primary transition-all"
                    />
                  </div>
                </div>
                    ...
                    filteredSongs.map(song => {
                      ...
                      return (
                        <div key={song.id} className="flex items-center gap-4 px-4 py-2.5 hover:bg-gray-100 dark:hover:bg-white/5 rounded-lg group transition-colors">
                          ...
                          {isAdded ? (
                            <span className="text-gray-400 dark:text-[#b3b3b3] text-sm font-medium px-3">Đã yêu thích</span>
                          ) : (
                            <button 
                              onClick={() => toggleFavorite(song)}
