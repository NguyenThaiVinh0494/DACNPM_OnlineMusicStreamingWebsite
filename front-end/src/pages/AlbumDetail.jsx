...
import { FiPlay, FiHeart, FiShare2, FiMoreHorizontal, FiDownload, FiClock, FiCheck, FiChevronRight } from "react-icons/fi";
...
const ALBUMS_DATA = {
  1: {
    ...
    songs: [
      ...
      { id: 103, title: "Yêu Em Thì Gật Đầu (Chill Mix)", artist: "Meme Media", uploader: "Meme Media", duration: "03:58", image: "https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?w=80&h=80&fit=crop" },
    ],
  },
  2: {
    id: 2,
    ...
    image: "https://images.unsplash.com/photo-1520872024865-3ff2805d8bb3?w=400&h=400&fit=crop",
    songs: [
      { id: 201, title: "Yêu Em Thì Gật Đầu", artist: "Lê Bảo Hân", uploader: "Bảo Hân Music", duration: "04:15", image: "https://images.unsplash.com/photo-1520872024865-3ff2805d8bb3?w=80&h=80&fit=crop" },
    ],
  },
  3: { id: 3, title: "Nếu Yêu Em Thì Gật Đầu", type: "Single", year: "2024", artistName: "Thanh Thơ", artistId: 3, uploader: "VietStar", uploadDate: "February 20, 2024", image: "https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?w=400&h=400&fit=crop", songs: [{ id: 301, title: "Nếu Yêu Em Thì Gật Đầu", artist: "Thanh Thơ", uploader: "VietStar", duration: "04:20", image: "https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?w=80&h=80&fit=crop" }] },
  4: { id: 4, title: "Yêu Em Thì Gật Đầu (Tú Remix)", type: "Single", year: "2024", artistName: "Ngô Mạnh Thắng, Meme Media", artistId: 1, uploader: "Meme Media", uploadDate: "April 5, 2024", image: "https://images.unsplash.com/photo-1470225620780-dba8ba36b745?w=400&h=400&fit=crop", songs: [{ id: 401, title: "Yêu Em Thì Gật Đầu (Tú Remix)", artist: "Ngô Mạnh Thắng", uploader: "Meme Media", duration: "03:58", image: "https://images.unsplash.com/photo-1470225620780-dba8ba36b745?w=80&h=80&fit=crop" }] },
  5: { id: 5, title: "Yêu Em Thì Gật Đầu (ZoneH Remix)", type: "Single", year: "2024", artistName: "Ngô Mạnh Thắng, Meme Media", artistId: 1, uploader: "Meme Media", uploadDate: "May 1, 2024", image: "https://images.unsplash.com/photo-1614613535308-eb5fbd3d2c17?w=400&h=400&fit=crop", songs: [{ id: 501, title: "Yêu Em Thì Gật Đầu (ZoneH Remix)", artist: "Ngô Mạnh Thắng", uploader: "Meme Media", duration: "04:15", image: "https://images.unsplash.com/photo-1614613535308-eb5fbd3d2c17?w=80&h=80&fit=crop" }] },
};

const FALLBACK = {
  id: 99, title: "Album không tìm thấy", type: "Album", year: "2024",
  artistName: "Unknown Artist", artistId: 1, uploader: "NCT Music",
  uploadDate: "January 1, 2024",
  image: "https://images.unsplash.com/photo-1493225457124-a1a2a5f5f92d?w=400&h=400&fit=crop",
  songs: [],
};
...
export default function AlbumDetail() {
  ...
  const { playSong, playAll, currentSong, isPlaying, favorites } = useMusic();
      ...
      <div className="flex gap-8 items-start">
        ...
        <div className="flex flex-col justify-center pt-2 flex-1 min-w-0">
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            >
              <div className={`p-2.5 rounded-full transition-colors ${liked ? "bg-red-900/20" : "bg-gray-100 dark:bg-white/5 hover:bg-gray-200 dark:hover:bg-white/10"}`}>
                <FiHeart className={`w-5 h-5 transition-colors ${liked ? "text-red-500 fill-current" : "text-gray-700 dark:text-white"}`} />
              </div>
              <span className="text-[10px] text-nct-text-dim">{liked ? 1 : 0}</span>
            </button>
            ...
            <button className="flex flex-col items-center gap-0.5">
              ...
              <span className="text-[10px] text-nct-text-dim">0</span>
            </button>
          ...
          album.songs.map((song, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Duration */}
                <span className="text-sm text-nct-text-dim text-center">{song.duration}</span>
                ...
                <div className="flex items-center justify-center relative" ref={isMenuOpen ? songMenuRef : null}>
                  <button
                    ...
                    className={`p-1.5 rounded-full transition-all dropdown-trigger
                      ${isMenuOpen ? "bg-gray-200 dark:bg-white/10 text-gray-900 dark:text-white opacity-100" : "text-gray-400 dark:text-nct-text-dim opacity-0 group-hover:opacity-100 hover:text-gray-900 dark:hover:text-white"}`}
                  >
